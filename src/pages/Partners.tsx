    ...
    <Layout>
      <div className="py-12 container mx-auto px-4 md:px-6 pt-28">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h1 className="text-4xl font-bold text-atdc-green mb-4">Meet Our Partners</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-atdc-green/10 rounded-xl shadow-md p-6">
          ...
          <div className="bg-[#CC5500]/10 rounded-xl shadow-md p-6">
